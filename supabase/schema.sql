...
insert into public.fortnite_codes (code, reward) values
  ...
  ('BORN2PLAY', 'Sprite Adventure · Cheat Master'),
  ('8BITBLAST', 'Sprite 8-Bit · Cheat Master'),
  ('IWANNAFLYHIGH', 'Sprite Tails · Cheat Master'),
  ('GOTTAGOFAST', 'Sprite Sonic · Cheat Master'),
  ('PLAY4ALL', 'Sprite Jonesy · Cheat Master'),
  ('O2OVERRIDE', 'Llama Supply Drop + 5 Extractores Portátiles'),
  ('TAKEYOURHEART', '2 Aceleradores de Extracción'),
  ('PERFECTORDER', '4 Tacos Picantes'),
  ('SURVIVETHENIGHT', '2 Extractores de Código'),
  ('FINDITCHAT', '2 Localizadores de Código'),
  ('OVERRIDEXP', '40,000 XP'),
  ('PERLIMPINPIN', '2,000 Polvo de Espíritu'),
  ('MAGILUME', '2,000 Polvo de Espíritu'),
