...
const initialGustambitos: Gustambito[] = [
  ...
  { id: 10, name: "Crown", subtitle: "Realeza en el lobby", rarity: "Mítico", color: "#e6534e", image: spriteUrl("Crown"), season: "GLITCH · Capítulo 7", variants: makeVariants("Crown", [0, 0, 0, 0], [["Base", ""], ["Dorado", "Gold"], ["Cheat Master", "Cheatmaster"], ["Loot Hacker", "Hacker"] as [string, string]]) },
  ...
  { id: 13, name: "Overshield", subtitle: "Otorga escudo adicional según el nivel", rarity: "Raro", color: "#68d8ee", image: spriteUrl("Overshield"), season: "GLITCH · Capítulo 7", variants: makeVariants("Overshield") },
  ...
  { id: 15, name: "X-Ray", subtitle: "Marca enemigos cercanos periódicamente", rarity: "Épico", color: "#f0d94d", image: spriteUrl("WinnerB"), season: "GLITCH · Capítulo 7", variants: makeVariants("WinnerB") },
  { id: 16, name: "Onigiri", subtitle: "Activa Overdrive al consumir", rarity: "Raro", color: "#f29a5b", image: spriteUrl("WinnerC"), season: "GLITCH · Capítulo 7", variants: makeVariants("WinnerC") },
];
