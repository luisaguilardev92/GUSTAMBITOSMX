...
const initialGustambitos: Gustambito[] = [
  ...
  { id: 17, name: "Crash Bandicoot", subtitle: "Un salto desata un torbellino", rarity: "Épico", color: "#f18434", image: spriteUrl("CrashBandicoot"), season: "GLITCH · Capítulo 7", variants: withLootHacker("CrashBandicoot", makeVariants("CrashBandicoot")) },
