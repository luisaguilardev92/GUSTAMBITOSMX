...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const markers = [
      { x: 24, y: 45, name: "DRIFT · PIERNAS", kind: "wrixel", detail: "Colina central" }, { x: 20, y: 54, name: "DRIFT · ACCESORIO", kind: "wrixel", detail: "Junto a la cascada" }, { x: 28, y: 47, name: "DRIFT · SOMBRERO", kind: "wrixel", detail: "Cruce de caminos verdes" }, { x: 29, y: 56, name: "DRIFT · TORSO", kind: "wrixel", detail: "Debajo del sitio de extracción" },
      { x: 75, y: 87, name: "LUXE · ACCESORIO", kind: "wrixel", detail: "Cubierta del yate pato" }, { x: 79, y: 91, name: "LUXE · TORSO", kind: "wrixel", detail: "Sauna junto a la piscina" }, { x: 81, y: 94, name: "LUXE · PIERNAS", kind: "wrixel", detail: "Piscina interior" }, { x: 78, y: 96, name: "LUXE · SOMBRERO", kind: "wrixel", detail: "Detrás del hotel" },
      { x: 57, y: 75, name: "SKULL RANGER · ACCESORIO", kind: "wrixel", detail: "Esquina noreste del laberinto" }, { x: 52, y: 80, name: "SKULL RANGER · SOMBRERO", kind: "wrixel", detail: "Centro del laberinto" }, { x: 47, y: 82, name: "SKULL RANGER · TORSO", kind: "wrixel", detail: "Corredor oeste inferior" }, { x: 53, y: 85, name: "SKULL RANGER · PIERNAS", kind: "wrixel", detail: "Corredor sur" },
      { x: 36, y: 37, name: "RUBY · TORSO", kind: "wrixel", detail: "Calle sur junto al edificio azul" }, { x: 39, y: 32, name: "RUBY · PIERNAS", kind: "wrixel", detail: "Parque junto al árbol rojo" }, { x: 40, y: 29, name: "RUBY · SOMBRERO", kind: "wrixel", detail: "Edificio de puertas amarillas" }, { x: 35, y: 35, name: "RUBY · ACCESORIO", kind: "wrixel", detail: "Canal bajo el puente" },
      { x: 25, y: 50, name: "GREEN HILL ZONE", kind: "cheat", detail: "Zona Cheat Code" }, { x: 77, y: 91, name: "CLUSTER COAST", kind: "cheat", detail: "Zona de alta densidad" }, { x: 60, y: 50, name: "REALITY'S REIGN", kind: "cheat", detail: "Zona de alta densidad" }, { x: 13, y: 75, name: "HEATWAVE HARBOR", kind: "cheat", detail: "Zona de alta densidad" }, { x: 68, y: 74, name: "SHAKEN SANCTUARY", kind: "cheat", detail: "Zona Cheat Code" },
    ];
    overlay.innerHTML = `<div class="map-panel"><button class="map-close" aria-label="Cerrar">×</button><div class="map-heading"><div><p class="eyebrow">GLITCH · ISLA OVERRIDE</p><h2>MAPA</h2><p>Ubica las piezas de Wrixel y las zonas con Cheat Codes.</p></div><div class="map-controls"><button data-map-filter="all" class="active">TODOS</button><button data-map-filter="wrixel">WRIXEL</button><button data-map-filter="cheat">CHEAT CODES</button></div></div><div class="map-viewport"><div class="map-canvas"><img src="https://fortnite-api.com/images/map.png" alt="Mapa de la isla Fortnite Override" /><div class="map-markers">${markers.map((marker) => `<button class="map-marker ${marker.kind}" data-map-kind="${marker.kind}" style="left:${marker.x}%;top:${marker.y}%"><span class="map-marker-dot"></span><strong>${marker.name}</strong><small>${marker.detail}</small></button>`).join("")}</div></div></div><div class="map-legend"><span><i class="legend-wrixel"></i> PIEZAS DE WRIXEL</span><span><i class="legend-cheat"></i> ZONA CHEAT CODE</span><small>Usa la rueda o pellizca directamente sobre el mapa · puntos orientativos por zona</small></div></div>`;
    document.body.append(overlay);
