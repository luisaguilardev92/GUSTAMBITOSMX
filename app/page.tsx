...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const markers = [
      ...
      { id: "luxe-accessory", x: 65.6327, y: 82.519, name: "LUXE · ACCESORIO", kind: "wrixel", detail: "Dentro del bote con forma de pato" }, { id: "luxe-torso", x: 68.373, y: 83.4705, name: "LUXE · TORSO", kind: "wrixel", detail: "Dentro del sauna en medio de la zona. Es el edificio con el logo del patito con gafas oscuras en la puerta" }, { id: "luxe-legs", x: 68.6394, y: 84.46, name: "LUXE · PIERNAS", kind: "wrixel", detail: "En un balcón de la parte sur de la zona urbanizada de Puerto Pacífico" }, { id: "luxe-hat", x: 69.8953, y: 82.9757, name: "LUXE · GORRA", kind: "wrixel", detail: "En la parte este de Puerto Pacífico, cerca de los contenedores de basura" },
      { id: "skull-ranger-accessory", x: 50.1978, y: 71.862, name: "SKULL RANGER · ACCESORIO", kind: "wrixel", detail: "En la parte noreste del laberinto" }, { id: "skull-ranger-hat", x: 49.2175, y: 72.4963, name: "SKULL RANGER · GORRA", kind: "wrixel", detail: "En la zona centro-norte del laberinto" }, { id: "skull-ranger-torso", x: 48.2398, y: 72.0147, name: "SKULL RANGER · TORSO", kind: "wrixel", detail: "Al oeste de la parte anterior de Wrixel" }, { id: "skull-ranger-legs", x: 48.1637, y: 74.0319, name: "SKULL RANGER · PIERNAS", kind: "wrixel", detail: "En la parte suroeste del laberinto" },
      { id: "ruby-torso", x: 36.8194, y: 39.973, name: "RUBY · TORSO", kind: "wrixel", detail: "En la parte suroeste de la zona" }, { id: "ruby-legs", x: 39.1837, y: 38.8197, name: "RUBY · PIERNAS", kind: "wrixel", detail: "Entre los árboles del parque cerca al teatro Golden Reel" }, { id: "ruby-hat", x: 39.1837, y: 34.6101, name: "RUBY · GORRA", kind: "wrixel", detail: "Dentro de este edificio en la parte norte de la zona" }, { id: "ruby-accessory", x: 39.9333, y: 36.4554, name: "RUBY · ACCESORIO", kind: "wrixel", detail: "Bajando por las escaleras al lado del canal en la parte noreste de la zona" },
    ];
    ...
    const guideImagesById: Record<string, string> = {
      ...
      "ruby-torso": "https://i0.wp.com/www.gamerfocus.co/wp-content/uploads/2026/08/Fortnite_20260820083357.jpg?resize=1024%2C576&ssl=1",
      "ruby-legs": "https://i0.wp.com/www.gamerfocus.co/wp-content/uploads/2026/08/Fortnite_20260820082846.jpg?resize=1024%2C576&ssl=1",
      ...
      "ruby-accessory": "https://i0.wp.com/www.gamerfocus.co/wp-content/uploads/2026/08/Fortnite_20260820083332.jpg?resize=1024%2C576&ssl=1",
