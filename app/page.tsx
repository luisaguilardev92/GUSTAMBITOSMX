...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const markers = [
      { id: "drift-legs", x: 24, y: 45, name: "DRIFT · PIERNAS", kind: "wrixel", detail: "Colina central" }, { id: "drift-accessory", x: 20, y: 54, name: "DRIFT · ACCESORIO", kind: "wrixel", detail: "Junto a la cascada" }, { id: "drift-hat", x: 28, y: 47, name: "DRIFT · SOMBRERO", kind: "wrixel", detail: "Cruce de caminos verdes" }, { id: "drift-torso", x: 29, y: 56, name: "DRIFT · TORSO", kind: "wrixel", detail: "Debajo del sitio de extracción" },
      { id: "luxe-accessory", x: 75, y: 87, name: "LUXE · ACCESORIO", kind: "wrixel", detail: "Cubierta del yate pato" }, { id: "luxe-torso", x: 79, y: 91, name: "LUXE · TORSO", kind: "wrixel", detail: "Sauna junto a la piscina" }, { id: "luxe-legs", x: 81, y: 94, name: "LUXE · PIERNAS", kind: "wrixel", detail: "Piscina interior" }, { id: "luxe-hat", x: 78, y: 96, name: "LUXE · SOMBRERO", kind: "wrixel", detail: "Detrás del hotel" },
      { id: "skull-ranger-accessory", x: 57, y: 75, name: "SKULL RANGER · ACCESORIO", kind: "wrixel", detail: "Esquina noreste del laberinto" }, { id: "skull-ranger-hat", x: 52, y: 80, name: "SKULL RANGER · SOMBRERO", kind: "wrixel", detail: "Centro del laberinto" }, { id: "skull-ranger-torso", x: 47, y: 82, name: "SKULL RANGER · TORSO", kind: "wrixel", detail: "Corredor oeste inferior" }, { id: "skull-ranger-legs", x: 53, y: 85, name: "SKULL RANGER · PIERNAS", kind: "wrixel", detail: "Corredor sur" },
      { id: "ruby-torso", x: 36, y: 37, name: "RUBY · TORSO", kind: "wrixel", detail: "Calle sur junto al edificio azul" }, { id: "ruby-legs", x: 39, y: 32, name: "RUBY · PIERNAS", kind: "wrixel", detail: "Parque junto al árbol rojo" }, { id: "ruby-hat", x: 40, y: 29, name: "RUBY · SOMBRERO", kind: "wrixel", detail: "Edificio de puertas amarillas" }, { id: "ruby-accessory", x: 35, y: 35, name: "RUBY · ACCESORIO", kind: "wrixel", detail: "Canal bajo el puente" },
