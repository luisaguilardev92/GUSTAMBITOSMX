...
const initialGustambitos: Gustambito[] = [
  ...
  { id: 10, name: "Victorioso", subtitle: "Realeza en el lobby", rarity: "Mítico", color: "#e6534e", image: spriteUrl("Crown"), season: "GLITCH · Capítulo 7", variants: makeVariants("Crown", [0, 0, 0], [["Base", ""], ["Cheat Master", "Cheatmaster"], ["Dorado", "Gold"]]).concat({ label: "Loot Hacker", image: spriteUrl("Crown", "Hacker"), level: 0, available: true }) },
