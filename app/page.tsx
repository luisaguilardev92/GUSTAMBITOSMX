...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const markerHtml = markers.map((marker, index) => {
      ...
      const secondImage = marker.id === "drift-torso" ? "https://i0.wp.com/www.gamerfocus.co/wp-content/uploads/2026/08/Fortnite_20260820104024.jpg?resize=1024%2C576&ssl=1" : "";
