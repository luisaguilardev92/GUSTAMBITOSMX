...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const markers = [
      { id: "drift-legs", x: 31.0371, y: 48.7988, name: "DERIVA · PIERNAS", kind: "wrixel", detail: "Colina central de Green Hill" }, { id: "drift-accessory", x: 26.8126, y: 47.9234, name: "DERIVA · ACCESORIO", kind: "wrixel", detail: "Junto a la cascada" }, { id: "drift-hat", x: 28.5633, y: 46.5152, name: "DERIVA · SOMBRERO", kind: "wrixel", detail: "Cruce de caminos verdes" }, { id: "drift-torso", x: 28.0304, y: 48.8749, name: "DERIVA · TORSO", kind: "wrixel", detail: "Cliff bajo el sitio de extracción" },
